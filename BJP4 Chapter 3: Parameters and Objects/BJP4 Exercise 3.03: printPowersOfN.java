...
If you use it, you may need to cast its results from double to int so that you don't see a .0 
after each number in your output. Also, can you write this program without using the Math class?)
*/

public static void printPowersOfN (double base, double exp) {
    for (int i = 0; i <= exp; i++) {
        int output = (int) Math.pow(base, i);

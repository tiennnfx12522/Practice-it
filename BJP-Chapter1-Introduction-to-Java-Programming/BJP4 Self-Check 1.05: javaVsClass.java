...
a. A .java file contains code written in the Java language, and a .class file contains code written in the C++ language.
...
c. The .class file is for object-oriented programming and the .java file is for procedural programming.
d. The programmer writes the .class file first, and the .java file is generated automatically later.
e. A .java file is a much larger binary file and a .class file is a smaller compressed version.
*/
